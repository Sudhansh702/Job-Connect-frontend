...
export default function Register() {
    ...
    async function handleSubmit(e) {
        e.preventDefault();
        const { username, password, email, fullName, professionalTitle } = userData
        if (!username || !password || !email || !fullName || !professionalTitle) {
    ...
    return (
        <div className="flex justify-center items-center h-screen bg-gray-50 flex-col p-7">
            ...
            <div className="w-full max-w-md p-5 bg-white rounded-lg shadow-md">
                ...
                <p className="text-center text-gray-600 mb-6">Join JobMatch to find your next opportunity</p>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            onChange={(e) => setUserData({ ...userData, professionalTitle: e.target.value })}
                            className="w-full mt-1 p-2 border border-gray-300 rounded"
                        />
                    </div>
                    <button
